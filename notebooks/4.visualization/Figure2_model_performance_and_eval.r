...
# saving file
ggsave(filename = "figures/fig2_B_training_confusion_matrix.png", height = height, width = width, dpi = 600)
...
ggsave("figures/fig2_D_only_test_train_pr_curve.png", width = width, height = height, dpi=600)

fig2_D_pr_curve_plot_train_test
